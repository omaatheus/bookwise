    ...
    <?php foreach($livros as $livro): ?>
            ...
            <div class="p-2 rounded border-stone-800 border-2 bg-stone-900">
                ...
                <div class="flex">
                    ...
                    <div class="w-1/3"><?= $livro->user_id ?></div>
        ...
        <div class="border border-stone-700 rounded">
            ...
            <form class="p-4 space-y-4" method="POST" action="/livro-criar">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="autor" class="border-stone-800 border-2 rounded-md bg-stone-900 text-sm focus:outline-none px-2 py-1 w-full">
